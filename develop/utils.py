...
def get_last_num_operations(operations_with_from, num_of_operations):
    ...
    last_file_operations = operations_sort[0:num_of_operations]
    return last_file_operations


def get_operations_formatted(last_file_operations):
    operations_formatted_list = []
    for operation in last_file_operations:
